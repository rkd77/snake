...
static unsigned char poleco[ROZMIAR];
static unsigned char listax[ROZMIAR];
static unsigned char listay[ROZMIAR];
static unsigned char last_x, last_y, prev_x, prev_y, cur_x, cur_y, nowy_kierunek;
static bool koniec, przerwa, blad, zjadl;
static unsigned short int liczba_czach, liczba_jablek, zjedzone, rekord;

static unsigned short ile_wolnych;
static signed short pocz, kon;
static unsigned short liczba_wisienek;
static unsigned char stary_kierunek;
static bool zjadl_jablko;
...
static short int x_krok[] = {-1, 0, 1, 0};
static short int y_krok[] = {0, -1, 0, 1};

static FXColor kolor[] = {
	FXRGB(0, 170, 172), // TLO
